...
O subconjunto utilizado neste projeto é o *UFPR05*, capturado do 5º andar do prédio da Universidade Federal do Paraná (UFPR), em Curitiba, Brasil.
...
| Informação | Detalhe |
|---|---|
| 📷 Total de imagens utilizadas (UFPR05) | 3.416 imagens |
...
Processa as 3.416 imagens *uma por uma*, em sequência. Para cada imagem:
...
Usa a mesma lógica de classificação do serial.py, mas distribui as 3.416 imagens entre múltiplos processos usando multiprocessing.Pool. O script testa automaticamente 4 configurações:
...
### 🔗 [https://huggingface.co/datasets/Voxel51/PKLot/tree/main/data/data_9](https://huggingface.co/datasets/Voxel51/PKLot/tree/main/data/data_9)
